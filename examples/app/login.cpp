...
// void LoginComponent::onClick(Cosmonaut::Event *event) {
//     printf("::: ON CLICK\n");
// }

// std::shared_ptr<Cosmonaut::Api::CElement> LoginComponent::render(Cosmonaut::Context &context) {
...
//         {Cosmonaut::StyleProp::Width, width},
//         {Cosmonaut::StyleProp::Height, height},
//         {Cosmonaut::StyleProp::AnimationName, "slide-in"}
//     });
...
//             .withTextAlign(Cosmonaut::Align::Center)
//             .withAnimationName("fade-in");
//     });

//     document.styleManager.addRule([](StyleRule& rule) {
//         rule.addId("login-button");
//         rule.addPseudoClass(Cosmonaut::PseudoClass::Hover);
